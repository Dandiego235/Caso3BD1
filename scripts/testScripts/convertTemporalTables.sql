...
-- Fecha: 04/18/2023
-- Descripcion: En este script se convierten algunas tablas que tienen columnas de validTo y validFrom en temporal tables.
-----------------------------------------------------------
...
INSERT INTO nombres (nombreBase, idiomaId, enabled) VALUES
('Colón costarricense', 1, 1),
('Dólar estadounidense', 1, 1),
